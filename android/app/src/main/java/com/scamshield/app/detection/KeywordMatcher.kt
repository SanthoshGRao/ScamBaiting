...
class KeywordMatcher @Inject constructor(
    ...
    companion object {
        ...
        private val FALLBACK_KEYWORDS: List<ScamKeywordEntity> = listOf(
            ...
            ScamKeywordEntity(keyword = "won", categoryId = "financial_fraud", weight = 0.5f),
            ...
            ScamKeywordEntity(keyword = "congratulations", categoryId = "financial_fraud", weight = 0.5f),
            ScamKeywordEntity(keyword = "selected", categoryId = "financial_fraud", weight = 0.3f),
            ScamKeywordEntity(keyword = "crore", categoryId = "financial_fraud", weight = 0.5f),
            ScamKeywordEntity(keyword = "lakh", categoryId = "financial_fraud", weight = 0.4f),
